...
export async function isUnique(args: {slug: string; context: ValidationContext}) {
...
export async function validateIntSlug(args: {slugArray?: SlugInt[]; context: ValidationContext}) {
